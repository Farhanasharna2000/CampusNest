      ...
      <div className="container mx-auto px-8">
        ...
        <div className="text-center pb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Step into a world of academic excellence where innovation meets tradition, 
            and every student's potential is unleashed through world-class education.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20">
                    <h3 className="text-white text-xl font-bold">{college.name}</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col flex-1 p-6 space-y-5">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-blue-900 font-bold ">Admission Duration</h4>
                    <p className="text-blue-600 text-sm">{college.admissionProcess.dates}</p>
                  </div>
                </div>

                {/* Events */}
                <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-2xl p-4">
                  <h4 className="text-blue-900 font-bold  mb-2">Campus Events</h4>
                  <div className="space-y-1">
                    {college.events.slice(0, 3).map((event, idx) => (
                      <div key={idx} className="flex items-center space-x-2 ">
                        <div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div>
                        <span className="text-blue-800 font-medium">{event.name}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="grid gap-3">
                  <div className="border border-blue-100 rounded-xl p-3 hover:bg-blue-50/50 transition-colors">
                    <h5 className="text-blue-900 font-semibold  mb-1">Research Excellence</h5>
                    <p className="text-blue-600 ">{college.research.overview}</p>
                  </div>
                  <div className="border border-blue-100 rounded-xl p-3 hover:bg-blue-50/50 transition-colors">
                    <h5 className="text-blue-900 font-semibold  mb-1">Sports Programs</h5>
